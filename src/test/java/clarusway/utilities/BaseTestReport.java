...
public class BaseTestReport {
    ...
    public void teardown(ITestResult result) throws IOException {
      if(result.getStatus()==ITestResult.FAILURE){
          String screenshotShotLocation=ReusableMethods.getScreenshot(driver, result.getName());
          extentTest.fail(result.getName());
          extentTest.addScreenCaptureFromPath(screenshotShotLocation);
          extentTest.fail(result.getThrowable());

      }
      else if(result.getStatus()==ITestResult.SKIP){//EGER TEST CALISTIRILMADAN GEÇİLMEZSE
          extentTest.skip("Test Case is skipped:"+result.getTestName());//ıgnore olanlar
